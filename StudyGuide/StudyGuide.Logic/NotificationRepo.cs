...
namespace StudyGuide.Logic.EntityRepos
{
    public static class NotificationRepo
    {
        ...
        public static async void CheckStudyPlans()
        {
            ...
            if (studyPlan != null)
            {
                ...
                {
                    var tasks = await Factory.Default.GetTasksRepo().ShowAll(s.Begin, new ScheduleViewModel { Subject = s.Subject, WorkType = s.WorkType });
